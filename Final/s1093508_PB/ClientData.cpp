...
ClientData::ClientData( int accountNumberValue, 
   string lastNameValue, string firstNameValue, string cityNameValue, double balanceValue )
{
...
void ClientData::setCityName(string cityN)
{
   int length = cityN.size();
   length = ( length < 16 ? length : 15 );
   cityN.copy( cityName, length );
   cityName[ length ] = '\0'; // append null character to firstName
}
